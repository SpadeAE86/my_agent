...
class VoiceTimbre(SQLModel, table=True):
    __tablename__ = "voice_timbre"
    ...
    provider: str = Field(sa_column=Column(String(64), nullable=False, server_default="volcano", index=True))
    is_online: bool = Field(sa_column=Column(SmallInteger, nullable=False, server_default="1", index=True))
