...
class VoiceCloned(SQLModel, table=True):
    __tablename__ = "voice_cloned"
    ...
    status: int = Field(sa_column=Column(SmallInteger, nullable=False, server_default="1")) # 1=Training, 2=Success, 3=Failed, 4=Active
    prompt_text: Optional[str] = Field(sa_column=Column(Text, nullable=True))
